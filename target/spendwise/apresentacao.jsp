            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-black  text_nav" href="deslogar.jsp">
                                <i class="fas fa-eye fa-lg"></i> Deslogar
                            </a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-4 offset-md-2">
                                <div style="max-width: 500px;">
                                    ...
                                    </p><a class="btn btn-lg me-2 spend_text" role="button" href="inserir.html" style="background-color: #BFD1E8;">Começar!</a>
